...
const Navbar: React.FC = () => {
  ...
  return (
    <header className={`navbar${scrolled ? ' scrolled' : ' hidden'}`}>
      ...
      <div style={{ position: 'absolute', top: 34, right: 28, zIndex: 10, display: 'flex', gap: 8 }}>
        ...
        <button onClick={() => i18n.changeLanguage('de')} aria-label="Deutsch" style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}>
          {/* Bandiera DEU SVG */}
